        ...
        <div className='contact-container'>
            ...
            <div className='map-container'>
                ...
                <div className='contact-info'>
                    <div className={`${window.innerWidth > 480 ? '' : 'address'}`}><FontAwesomeIcon className='contact-icon' icon={faLocationDot} /><p>100 Siena Office Park Rd, Wake Forest, NC, 27587</p></div>

...
const Knowledge = () => {
    return (
        <div className='knowledge-container'>
            <span className='knowledge-title'>Encyclopedic Knowledge of The Custom Knife Industry</span>
            <hr />
            <div className='knowledge-content'>
                <img src={'https://www.knifepurveyor.com/wp-content/uploads/2020/12/custom-knife-reference-books.jpg'} alt='books' />
                <div className='knowledge-text'>
                    <p>We’re proud to be a part of the custom knife community, and our role as curators and cultural ambassadors is one we take seriously.</p>
                    <p>With over 20 years of experience collecting, studying, and selling knives, Michael Donato’s encyclopedic knowledge of the custom knife industry is a tremendous resource for interested collectors. Michael is always excited to lend his expertise — featured in trade magazines and knife shows around the world — to customers hoping to learn more or find the perfect piece of their collections.</p>
